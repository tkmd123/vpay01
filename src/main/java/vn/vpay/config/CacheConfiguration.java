...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            cm.createCache(vn.vpay.domain.Product.class.getName() + ".productProductItems", jcacheConfiguration);
            cm.createCache(vn.vpay.domain.ProductItem.class.getName(), jcacheConfiguration);
