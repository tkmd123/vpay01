...
public class Department implements Serializable {
    ...
    public Department departmentusers(Set<User> users) {
        this.departmentusers = users;
        return this;
    }

    public Department addDepartmentuser(User user) {
        this.departmentusers.add(user);
        user.setUserdepartment(this);
        return this;
    }

    public Department removeDepartmentuser(User user) {
        this.departmentusers.remove(user);
        user.setUserdepartment(null);
        return this;
    }

    public void setDepartmentusers(Set<User> users) {
        this.departmentusers = users;
    }
