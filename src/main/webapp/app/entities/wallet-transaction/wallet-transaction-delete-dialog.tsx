  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="vpay01App.walletTransaction.delete.question">
          <Translate contentKey="vpay01App.walletTransaction.delete.question" interpolate={{ id: walletTransactionEntity.id }}>
