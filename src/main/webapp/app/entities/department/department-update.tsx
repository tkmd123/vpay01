...
export class DepartmentUpdate extends React.Component<IDepartmentUpdateProps, IDepartmentUpdateState> {
  ...
  render() {
    const { departmentEntity, users, locations, loading, updating } = this.props;
          ...
          <Col md="8">
            {loading ? (
              ...
              <AvForm model={isNew ? {} : departmentEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label for="departmentuser.id">
                    <Translate contentKey="vpay01App.department.departmentuser">Departmentuser</Translate>
                  </Label>
                  <AvInput id="department-departmentuser" type="select" className="form-control" name="departmentuser.id">
                    <option value="" key="0" />
                    {users
