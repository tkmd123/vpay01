    ...
    return (
      <div>
        <h2 id="department-heading">
          <Translate contentKey="vpay01App.department.home.title">Departments</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />&nbsp;
            <Translate contentKey="vpay01App.department.home.createLabel">Create new Department</Translate>
          </Link>
        </h2>
        <Row>
          <Col sm="12">
              ...
              <AvGroup>
                <InputGroup>
                  <AvInput
                    ...
                    placeholder={translate('vpay01App.department.home.search')}
                  />
          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th>
                  <Translate contentKey="vpay01App.department.departmentName">Department Name</Translate>
                </th>
                <th>
                  <Translate contentKey="vpay01App.department.departmentuser">Departmentuser</Translate>
                </th>
                <th>
                  <Translate contentKey="vpay01App.department.location">Location</Translate>
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {departmentList.map((department, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>{department.departmentuser ? department.departmentuser.id : ''}</td>
