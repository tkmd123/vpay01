  ...
  render() {
    ...
    return (
      <Row>
        <Col md="8">
          <h2>
            <Translate contentKey="vpay01App.department.detail.title">Department</Translate> [<b>{departmentEntity.id}</b>]
          </h2>
          <dl className="jh-entity-details">
            ...
            <dd>{departmentEntity.departmentuser ? departmentEntity.departmentuser.id : ''}</dd>
            <dt>
