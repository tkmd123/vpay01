              ...
              <thead>
                <tr>
                  ...
                  <th className="hand" onClick={this.sort('partnerUrl')}>
                    <Translate contentKey="vpay01App.partner.partnerUrl">Partner Url</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('partnerStatus')}>
                    <Translate contentKey="vpay01App.partner.partnerStatus">Partner Status</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  ...
                  <th className="hand" onClick={this.sort('isDeleted')}>
                    <Translate contentKey="vpay01App.partner.isDeleted">Is Deleted</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th />
                </tr>
              </thead>
