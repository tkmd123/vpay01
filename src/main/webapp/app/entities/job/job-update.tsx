    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="vpay01App.job.home.createOrEditLabel">
              <Translate contentKey="vpay01App.job.home.createOrEditLabel">Create or edit a Job</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
          <Col md="8">
            {loading ? (
              ...
              <AvForm model={isNew ? {} : jobEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label for="tasks">
                    <Translate contentKey="vpay01App.job.task">Task</Translate>
                  </Label>
                  <AvInput
                    id="job-task"
                    type="select"
