    ...
    return (
      <div>
        <h2 id="pay-partner-log-heading">
          <Translate contentKey="vpay01App.payPartnerLog.home.title">Pay Partner Logs</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />&nbsp;
            <Translate contentKey="vpay01App.payPartnerLog.home.createLabel">Create new Pay Partner Log</Translate>
          </Link>
        </h2>
        <Row>
          <Col sm="12">
              ...
              <AvGroup>
                <InputGroup>
                  <AvInput
                    ...
                    placeholder={translate('vpay01App.payPartnerLog.home.search')}
                  />
            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={this.sort('payLogAmount')}>
                  <Translate contentKey="vpay01App.payPartnerLog.payLogAmount">Pay Log Amount</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={this.sort('payLogTransRef')}>
                  <Translate contentKey="vpay01App.payPartnerLog.payLogTransRef">Pay Log Trans Ref</Translate>{' '}
                  <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={this.sort('payLogUsername')}>
                  <Translate contentKey="vpay01App.payPartnerLog.payLogUsername">Pay Log Username</Translate>{' '}
                  <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={this.sort('payLogProductTypeCode')}>
                  <Translate contentKey="vpay01App.payPartnerLog.payLogProductTypeCode">Pay Log Product Type Code</Translate>{' '}
                  <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={this.sort('payLogResuleCode')}>
                  <Translate contentKey="vpay01App.payPartnerLog.payLogResuleCode">Pay Log Resule Code</Translate>{' '}
                  <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={this.sort('payLogResuleDesc')}>
                  <Translate contentKey="vpay01App.payPartnerLog.payLogResuleDesc">Pay Log Resule Desc</Translate>{' '}
                  <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={this.sort('payLogDate')}>
                  <Translate contentKey="vpay01App.payPartnerLog.payLogDate">Pay Log Date</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={this.sort('payLogUDF1')}>
                  <Translate contentKey="vpay01App.payPartnerLog.payLogUDF1">Pay Log UDF 1</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={this.sort('payLogUDF2')}>
                  <Translate contentKey="vpay01App.payPartnerLog.payLogUDF2">Pay Log UDF 2</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={this.sort('payLogUDF3')}>
                  <Translate contentKey="vpay01App.payPartnerLog.payLogUDF3">Pay Log UDF 3</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={this.sort('payLogUDF4')}>
                  <Translate contentKey="vpay01App.payPartnerLog.payLogUDF4">Pay Log UDF 4</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={this.sort('payLogUDF5')}>
                  <Translate contentKey="vpay01App.payPartnerLog.payLogUDF5">Pay Log UDF 5</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={this.sort('isDeleted')}>
                  <Translate contentKey="vpay01App.payPartnerLog.isDeleted">Is Deleted</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  <Translate contentKey="vpay01App.payPartnerLog.payPartner">Pay Partner</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
