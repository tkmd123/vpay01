    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="vpay01App.jobHistory.home.createOrEditLabel">
              <Translate contentKey="vpay01App.jobHistory.home.createOrEditLabel">Create or edit a JobHistory</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
              ...
              <AvForm model={isNew ? {} : jobHistoryEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="startDateLabel" for="startDate">
                    <Translate contentKey="vpay01App.jobHistory.startDate">Start Date</Translate>
                  </Label>
                  <AvInput
                ...
                <AvGroup>
                  <Label id="endDateLabel" for="endDate">
                    <Translate contentKey="vpay01App.jobHistory.endDate">End Date</Translate>
                  </Label>
                  <AvInput
                ...
                <AvGroup>
                  <Label id="languageLabel">
                    <Translate contentKey="vpay01App.jobHistory.language">Language</Translate>
                  </Label>
                  <AvInput
                  ...
                  >
                    <option value="FRENCH">
                      <Translate contentKey="vpay01App.Language.FRENCH" />
                    </option>
                    <option value="ENGLISH">
                      <Translate contentKey="vpay01App.Language.ENGLISH" />
                    </option>
                    <option value="SPANISH">
                      <Translate contentKey="vpay01App.Language.SPANISH" />
                    </option>
                  </AvInput>
                </AvGroup>
                <AvGroup>
                  <Label for="job.id">
                    <Translate contentKey="vpay01App.jobHistory.job">Job</Translate>
                  </Label>
                ...
                <AvGroup>
                  <Label for="department.id">
                    <Translate contentKey="vpay01App.jobHistory.department">Department</Translate>
                  </Label>
                ...
                <AvGroup>
                  <Label for="employee.id">
                    <Translate contentKey="vpay01App.jobHistory.employee">Employee</Translate>
                  </Label>
