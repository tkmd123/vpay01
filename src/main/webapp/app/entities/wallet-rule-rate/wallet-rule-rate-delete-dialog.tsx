  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="vpay01App.walletRuleRate.delete.question">
          <Translate contentKey="vpay01App.walletRuleRate.delete.question" interpolate={{ id: walletRuleRateEntity.id }}>
