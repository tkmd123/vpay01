...
import vn.vpay.domain.JobHistory;
import vn.vpay.repository.JobHistoryRepository;
import vn.vpay.repository.search.JobHistorySearchRepository;
import vn.vpay.service.JobHistoryService;
...
import vn.vpay.domain.enumeration.Language;
/**
...
public class JobHistoryResourceIntTest {
     ...
     *
     * @see vn.vpay.repository.search.JobHistorySearchRepositoryMockConfiguration
     */
    @Autowired
